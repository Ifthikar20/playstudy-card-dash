  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 flex">
        ...
        <div className={`${isMinimized ? 'w-12' : 'w-1/3'} bg-white border-r border-gray-200 transition-all duration-300`}>
          {isMinimized ? (
            <div className="p-3">
              <button
          ...
          {!speedRunStarted ? (
            ...
            <div className="max-w-2xl mx-auto h-full flex flex-col justify-center">
              ...
              <div className="relative h-80 mb-8">
                ...
                >
                  {/* Front of card */}
                  <div className="absolute inset-0 w-full h-full bg-white rounded-xl border border-gray-200 p-8 flex items-center justify-center backface-hidden">
                    <div className="text-center">
                  ...
                  {/* Back of card */}
                  <div className="absolute inset-0 w-full h-full bg-blue-50 rounded-xl border border-blue-200 p-8 flex items-center justify-center backface-hidden rotate-y-180">
                    <div className="text-center">
                      <h3 className="text-lg font-medium text-blue-900 mb-4">
                        {sampleCards[currentCard]?.back}
                      </h3>
                      <p className="text-sm text-blue-600">Click to go back</p>
                    </div>
                  </div>
                </div>
              </div>
